...
let foundItem = record.find(isWin)
...
//const superbowlWin = record.find(item=>console.log(item.year === "W" ));

//console.log(superbowlWin);

//const superbowlWin = record.find(item=>item.result === "W" )
